export const products = [
    {
        ...
        price: "109,90",
        description: "",
        items: "Vinho garrafa ( iniciais do casal) • Arranjo de flores secas • Chocolate barra • Cartão de felicitações • Caixa envelope carta",
        images: {
            1: "img/carta/1.jpg",
        },
    },
    {
        ...
        price: "129,90",
        description: "",
        items: "Urso Eu te amo • Bombons Ferrero Rocher • Polaroid de mesa (versão Instagram ou versão frase) • Cartão de felicitações • Embalagem em kraft",
        images: {
            1: "img/eternizar/1.jpg",
        },
    },
    {
        title: "Sonho Meu",
    ...
    //     price: "Esgotado",
    //     description:
    //         "Versão especial do Dia dos Namorados.\nÉ possível escolher entre a opção com mini urso ou quadrinho de foto.",
    //     items: "Caixa em mdf 30x20 • Biscoitos amanteigados caseiros de Coração e chocolate • Torradinhas temperadas  • Bombons • Brownie recheado • Suco de Uva e laranja • Flor  • Croissants recheados  • Urso mini ou quadrinho de foto • Cartão de felicitações",
    //     images: {
    //         1: "img/bombons/1.jpg",
    //         2: "img/bombons/2.jpg",
    //     },
